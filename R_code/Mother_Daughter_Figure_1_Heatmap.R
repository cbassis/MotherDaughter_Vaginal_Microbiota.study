...
### sorting Distance, then Pair, then Subject, then Sample_time ; deleted column A
### saved as motherdaughter.otu.heatmap.ordered.wcolumns.txt, deleted all columns except Sample and OTU rel abunances, saved as motherdaughter.otu.heatmap.ordered.txt

otu.ordered.rel.filtered<-read.table("motherdaughter.otu.heatmap.ordered.txt", header=TRUE, row.names=1)
meta2<-read.table(file = "motherdaughter.otu.heatmap.ordered.wcolumns.txt", header = TRUE, row.names = 1)
...
## in terminal: perl /Users/christinebassis/Box\ Sync/Microbiome_Explorer_Program/Aslam_102615_no_females/Cecal_male_103015/Alyxcode.pl /Users/christinebassis/Box\ Sync/Mother_daughter_analysis/121317_mother_daughter_copy/OTUlist.txt /Users/christinebassis/Box\ Sync/Mother_daughter_analysis/motherdaughter.files.trim.contigs.good.unique.good.filter.unique.precluster.pick.pick.an.unique_list.0.03.cons.taxonomy 
#2/9/18 output accidentaly overwrote original version in "/Users/christinebassis/Box Sync/Mother_daughter_analysis/", copied to working directory, "/Users/christinebassis/Box Sync/Mother_daughter_analysis/121317_mother_daughter_copy/":motherdaughter.files.trim.contigs.good.unique.good.filter.unique.precluster.pick.pick.an.unique_list.0.03.cons.taxonomy.subset.txt
